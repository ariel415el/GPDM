...
def main():
    ...
    # input_image_path = '/home/ariel/university/GPDM/images/SIGD16/12.jpg'
    ...
    for resize in [128, 256, 512, 1024]:
        ...
        save_image(result, os.path.join(output_dir, f"R-{resize}_{os.path.basename(input_image_path)}"))
